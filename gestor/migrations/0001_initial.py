# Generated by Django 5.0 on 2024-03-03 15:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titulo', models.CharField(max_length=200)),
                ('actividad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestor.hito')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('abierto', 'Proyectos Integración'), ('suspendido', 'Necesidades entrega operación'), ('desarollo', 'Proyectos Producto Propio'), ('cerrado', 'Cerrado')], max_length=50)),
                ('lider', models.CharField(max_length=100)),
                ('categoria', models.CharField(choices=[('I', 'Tipo I'), ('II', 'Tipo II'), ('III', 'Tipo III'), ('IV', 'Tipo IV')], max_length=100)),
                ('antecedentes', models.TextField()),
                ('fase', models.CharField(choices=[('inicio', 'Inicio'), ('planeacion', 'Planeación'), ('ejecucion', 'Ejecución'), ('monitoreo_control', 'Monitoreo y Control'), ('cierre', 'Cierre')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('probavilidad', models.CharField(choices=[('medio', 'Medio'), ('alto1', 'Alto'), ('alto2', 'Muy Alto'), ('bajo1', 'Bajo'), ('Bajo2', 'Muy Bajo')], max_length=20)),
                ('gravedad', models.CharField(choices=[('medio', 'Medio'), ('alto1', 'Alto'), ('alto2', 'Muy Alto'), ('bajo1', 'Bajo'), ('Bajo2', 'Muy Bajo')], max_length=20)),
